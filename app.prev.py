...
from extractors.leadership import try_extract_answer as try_leadership  # safety net direct import
...
def answer_with_rag(question: str):
    ...
    # Safety net: if the question is about sōke and no fact yet, call leadership extractor directly
    asking_soke = any(t in question.lower() for t in ["soke", "sōke", "grandmaster", "headmaster", "current head", "current grandmaster"])
    if not fact and asking_soke:
        try:
